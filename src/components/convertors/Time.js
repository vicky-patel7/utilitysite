...
import { convertTime, timeUnitOptions } from '../../../src/utils/timeUtils'

const unitOptions = Object.keys(timeUnitOptions);

const Time = () => {

  const [sourceUnit, setSourceUnit] = useState('seconds');
  ...
  useEffect(() => {
    try {
      setResult(convertTime(sourceUnit, targetUnit, sourceValue));
    } catch (e) {
